...
if __name__ == "__main__":
    ...
    print("area:", triangle_area(sampleBreadth, sampleHeight))
    print("perimeter:", semicircle_perimeter(sampleRadius))
    print("volume:", cylinder_volume(sampleRadius, sampleHeight))
    print("surface_area:", cube_surface_area(sampleLength))
